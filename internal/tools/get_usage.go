...
const Instructions = "video-studio-mcp assembles a narrated presentation video (MP4) from a page manifest: " +
	...
	"(e.g. voice-studio-mcp supplies the audio). It is stateful and file-mediated: " +
	"the agent places images, audio, and the manifest in a workspace directory; outputs are returned as file paths. " +
